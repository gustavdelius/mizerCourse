...
```{r collect-parameters-2, message=FALSE}
library(rfishbase)
```
...
```{r collect-parameters-3, eval=FALSE}
...
```{r collect-parameters-21, eval=FALSE}
...
```{r collect-parameters-25, eval=FALSE}
...
```{r collect-parameters-27, eval=FALSE}
