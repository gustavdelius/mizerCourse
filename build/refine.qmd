...
```{r refine-11, warning=FALSE, message=FALSE, eval=FALSE}
...
<!-- ```{r refine-14, warning=FALSE, message=FALSE} -->
<!-- stomach |> -->
...
<!-- ```{r refine-16, warning=FALSE, message=FALSE} -->
...
<!-- ```{r refine-17, warning=FALSE, message=FALSE} -->
...
<!-- ```{r refine-18, warning=FALSE, message=FALSE} -->
<!-- binned <- stomach %>%  -->
<!--     # bin data -->
...
<!-- ```{r refine-19, warning=FALSE, message=FALSE} -->
<!-- ggplot(binned, aes(bin, log_ppmr)) + -->
