...
```{r predation-growth-and-mortality-1}
#| message: false
library(mizer)
...
```{r predation-growth-and-mortality-2}
...
```{r predation-growth-and-mortality-3}
...
```{r predation-growth-and-mortality-4}
...
```{r predation-growth-and-mortality-5}
...
```{r predation-growth-and-mortality-6}
...
```{r predation-growth-and-mortality-7}
#| fig-show: hold
#| fig-height: 2
growth_rates_plot 
spectra_plot
...
```{r predation-growth-and-mortality-8}
...
Fish will be particularly good at catching prey in a specific range of sizes, smaller than themselves. This is encoded in the size-spectrum model by the predation kernel. Let us take a look at the predation kernel in our model. We can obtain it with the function `pred_kernel()`.

```{r predation-growth-and-mortality-9}
...
```{r predation-growth-and-mortality-10}
...
```{r predation-growth-and-mortality-11}
...
```{r predation-growth-and-mortality-12}
...
```{r predation-growth-and-mortality-13, message=FALSE}
params_pk <- params
...
```{r predation-growth-and-mortality-14}
...
```{r predation-growth-and-mortality-15}
...
```{r predation-growth-and-mortality-16}
species_params(params)$gamma
```

We change that to 1000 and find the new steady state.

```{r predation-growth-and-mortality-17, message=FALSE}
...
```{r predation-growth-and-mortality-18}
#| warning: false
...
```{r predation-growth-and-mortality-19}
#| warning: false
#| layout-ncol: 2
#| fig-cap: 
#|   - "Original"
...
```{r predation-growth-and-mortality-20}
...
```{r predation-growth-and-mortality-21}
gear_params(params)
```
...
```{r predation-growth-and-mortality-22}
...
```{r predation-growth-and-mortality-23}
