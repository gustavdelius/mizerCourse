...
```{r dynamics-of-spectra-2, message=FALSE}
...
```{r dynamics-of-spectra-9, message=FALSE}
...
We can get the reproduction levels of the different species with `reproduction_level()`:

```{r dynamics-of-spectra-13}
...
```{r dynamics-of-spectra-17, message=FALSE}
