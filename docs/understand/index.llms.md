...
1.  [**Observed size spectra**](../understand/observed-size-spectra.llms.md)  
...
2.  [**Single-species spectra**](../understand/single-species-spectra.llms.md)  
...
3.  [**Predation, growth and mortality**](../understand/predation-growth-and-mortality.llms.md)  
...
4.  [**Species interactions**](../understand/species-interactions.llms.md)  
...
5.  [**Dynamics of spectra**](../understand/dynamics-of-spectra.llms.md)  
