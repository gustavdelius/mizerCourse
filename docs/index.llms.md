...
- **[Part 1: Understand](understand/index.llms.md)**  
...
- **[Part 2: Build](build/index.llms.md)**  
...
To get started, [install the tools](prepare/install-tools.llms.md) you need and then go to [Part 1](understand/index.llms.md) to learn about size spectra and their dynamics.
